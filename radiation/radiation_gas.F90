...
!   2021-03-01  P. Ukkonen Added support for RRTMGP gas types
...
module radiation_gas
  ...
  type gas_type
    ...
    ! Gas derived type for RRTMGP, which stores volume mixing ratios as either scalars,
    ! 1-dimensional profiles (nlev), or 2-D fields (nlev,ncol). 
    ! gas_rrtmgp is only allocated and used when RRTGMP is used
