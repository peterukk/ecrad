...
module radiation_config
  ...
  ! Gas models
  enum, bind(c) 
     enumerator IGasModelMonochromatic, IGasModelIFSRRTMG, IGasModelECCKD, IGasModelRRTMGP
  end enum
  character(len=*), parameter :: GasModelName(0:3) = (/ 'Monochromatic', &
       &                                                'RRTMG-IFS    ', &
       &                                                'ECCKD        ', &
       &                                                'RRTMGP       ' /)
...
!         &      "baum-general-habit-mixture_ice"]
    ...
    ! For RRTMGP gas optics: use neural networks to speed up computatinos?
    logical :: do_rrtmgp_neural_nets = .false.
    ...
    ! RRTMGP-NN
    type(network_type), dimension(4) :: rrtmgp_neural_nets ! 1:SW-tau, 2:SW-ray, 3:LW-tau, 4:LW-planck 
...
contains
  ...
  subroutine read_config_from_namelist(this, file_name, unit, is_success)
    ...
    do_rrtmgp_neural_nets = this%do_rrtmgp_neural_nets
    ...
    this%do_rrtmgp_neural_nets = do_rrtmgp_neural_nets
  ...
  subroutine consolidate_config(this)
    ...
    this%rrtmgp_gas_optics_file_name_lw &
      & = trim(this%directory_name) // "/rrtmgp-data-lw-g256-2018-12-04-ECRADNAMES.nc"
    this%rrtmgp_gas_optics_file_name_sw &
      & = trim(this%directory_name) // "/rrtmgp-data-sw-g224-2018-12-04-ECRADNAMES.nc"
    this%rrtmgp_neural_net_sw_tau &
      & = trim(this%directory_name) // "/rrtmgp_neural_net_sw_tau_7_16_16.txt"
    this%rrtmgp_neural_net_sw_ray &
      & = trim(this%directory_name) // "/rrtmgp_neural_net_sw_ray_7_16_16.txt" 
    this%rrtmgp_neural_net_lw_tau &
      & = trim(this%directory_name) // "/rrtmgp_neural_net_lw_tau_18_58_58.txt"
    this%rrtmgp_neural_net_lw_pfrac &
      & = trim(this%directory_name) // "/rrtmgp_neural_net_lw_pfrac_18_16_16.txt"
