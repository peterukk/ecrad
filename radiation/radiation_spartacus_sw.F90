...
#ifdef USE_TIMING
     ret =  gptlstop('expm1')
     ret =  gptlstart('ref_trans_matrices')
#endif 
...
#ifdef USE_TIMING
     ret =  gptlstop('ref_trans_matrices')
#endif 
...
#ifdef USE_TIMING
     ret =  gptlstart('section_4_1-adding_cloudy')
#endif 
